...
::: {.fragment .strike}
Back in the beginning, I wrote an R package for my org
:::

## ...how bad was this incident?

Back in the beginning, I wrote an R package for __myself__

::: {.fragment .fade-in}
<img src="img/logo2.png" data-lazy-loaded="" style="float: right; width: 35%">
:::
...
- seeing how you fit into your team
...
## How is your water? {background-color=`r section1_color`}
...
# All knowledge is valuable {background-color=`r section2_color`}  


##  {background-color=`r section2_color`}
...
## Data science is a creative field {background-color=`r section3_color`}
...
```{mermaid}
flowchart LR
  A(Documentation) === B[[Communication]]
