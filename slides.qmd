...
link-external-filter: "lizroten.com"
format: 
  revealjs:
...
# Could my manager have prevented or fixed this?
...
You can __shape__ your team by caring for your team, and seeing how you fit into it. 
...
fish_base <- ggplot() +
  ...
  theme(legend.position = "none",
        plot.background = element_rect(fill = "#A1B4B9",
                                       colour = NA))

new_fish <- geom_fish(mapping = aes(x = 0.15,
                                    y = 0.55,
                                    fish = "goldfish2"),
                      size = 3
) 
...
## {auto-animate=true background-color="#A1B4B9"}
...
## Figure out what your water is like {background-color="#A1B4B9"}
...
## Don't deny that water exists {background-color="#A1B4B9"}
...
# All knowledge is valuable {background-color="#E3C0B6"}

## Data science is a creative field. {background-color="#E3C0B6"}


<!-- they have certain skill your team may have been lacking -->

<!-- You can hand two different people a challenging problem and they both can come up with totally different ways of solving it -->
...
## Honor your new colleague {background-color="#E3C0B6"}
...
# Document {background-color="#D9CBBF"}


## A matter of investment {background-color="#D9CBBF"}
...
## Work doesn't always feel like work {background-color="#D9CBBF"}
...
- David Foster Wallace 2005 Kenyon College commencement speech [here](https://fs.blog/david-foster-wallace-this-is-water/)
